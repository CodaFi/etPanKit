...
@property (nonatomic, retain) NSDictionary *mimeTypesDictionary;
@property (nonatomic, retain) NSDictionary *extensionsAsMimesDictionary;
...
-(id)init {
	if (self = [super init]) {
		_possibleImageExtensions = [NSArray arrayWithObjects:@"jpg", @"jpeg", @"png", @"gif", @"tiff", @"tif", nil];
		_possibleImageMimeTypes = [NSArray arrayWithObjects:@"image/jpeg", @"image/gif", @"image/png", @"image/tiff", @"image/tif", nil];
		_possibleArchiveMimeTypes = [NSArray arrayWithObjects:@"zip",@"sfark",@"s7z",@"ace",@"cpt",@"dar",@"pit",@"sea",@"sit",@"par",
									 @"par2",@"gz",@"tgz",@"bz2",@"tbz",@"Z",@"taz",@"lz",@"tlz",@"7z", nil];
		_mimeTypesDictionary = [NSDictionary dictionaryWithObjectsAndKeys:@"image/jpeg", @"jpg", @"image/jpeg", @"jpeg",
		...
		_extensionsAsMimesDictionary = [NSDictionary dictionaryWithObjectsAndKeys:@"jpg", @"image/jpeg", @"jpeg", @"image/jpeg",
...
-(NSString*)mimeTypeForFile:(NSString *)filename {
	return [self.mimeTypesDictionary objectForKey:[filename.pathExtension lowercaseString]];
}

- (NSString*)fileExtensionForMimeType:(NSString*)mimeType {
	return [self.extensionsAsMimesDictionary objectForKey:[mimeType lowercaseString]];
}
